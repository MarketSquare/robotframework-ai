# NOTES
# Add option to select number format from basic formats
# Do separate function for DirectLineNumberGenerator.py or include in this?
...
# Copied from AddressGenerator, will be edited
